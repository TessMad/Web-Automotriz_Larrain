...
$message = "<h2>Consignar Vehículo Web Automotriz Larrain</h2>";
...
$subject = "Consignación Online Web Automotriz Larrain";
$message  .= "<br> Nombre Completo : " . $Nombre . "<br>Email : "  . $Email . "<br>Telefono : "  . $Telefono . "<br>Marca : "  . $Marca . "<br>Modelo : "  . $Modelo . "<br>Version : "  . $Version. "<br>Año : "  . $Anio ."<br>Kilometraje : " .$Kms;
